...
StepRepeat.tempLayerName = "__TOOLKIT_STEP_REPEAT_SYMBOL_TEMP__";
StepRepeat.templateGroupName = "__TOOLKIT_STEP_REPEAT_SYMBOL_TEMPLATE__";
StepRepeat.outputGroupName = "STEP_REPEAT_SYMBOL_GRID";
StepRepeat.symbolItemPrefix = "STEP_REPEAT_SYMBOL_ITEM_";
...
StepRepeat.resolveOutputContainer = function (doc, items) {
    ...
    if (!doc.activeLayer || doc.activeLayer.locked === true || doc.activeLayer.visible === false) {
        throw StepRepeat.createModuleError(
            "STEP_REPEAT_UNSUPPORTED_ITEM",
            "Active layer is unavailable for Step Repeat Symbol output."
        );
    }
