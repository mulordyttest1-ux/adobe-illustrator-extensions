...
import { serializeFormState as mapFormState } from './processing_option_mapper.js';
import {
    DEFAULT_SCHEMA_ID,
    INVARIANT_FIELD_IDS,
    normalizePresetSchema as normalizeSchemaPolicy
} from './preset_schema_policy.js';
...
export function normalizePresetSchema(schema) {
    return normalizeSchemaPolicy(schema);
}

export const serializeFormState = mapFormState;
